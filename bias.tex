...
was collected that is balanced in gender and skin tone type called the Pilot
...
primarily use this benchmark dataset for evaluation (as test set) in this
...
\begin{itemize}
	...
	This could potenially attract solutions involving both traditional 
	segmentation and manipulation and recent generative (and/or adversarial) 
	for skin tone manipulation.
	...
	facial and full-body attributes recognition becomes increasingly important
...
competition. As mentor to Esube at NRL, Wallace also will oversea the
